...
public class DispatchController {
    ...
    @GetMapping
    @Operation(summary = "Get all reports for enterprise manager")
    public ApiResponse<PageResponse<InboxReportItemResponse>> getAllReports(@ParameterObject Pageable pageable) {
